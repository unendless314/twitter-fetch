...
executed_at: "2026-04-13T05:01:07.511417+08:00"
status: "success"
---
...
[
  {
    ...
    "relevance_note": "Reports on Alibaba's new AI video model HappyHorse-1.0 launch and its top ranking on Artificial Analysis benchmarks, supported by images likely showing rankings."
  },
  {
    ...
    "relevance_note": "Details Alibaba's anonymous launch of AI video model HappyHorse-1.0, topping benchmarks on Artificial Analysis ahead of competitors, with media evidence."
  },
  {
    ...
    "media_urls": [
      "https://pbs.twimg.com/media/HFZUVAva8AQhMyk.jpg"
    ],
    "relevance_note": "Provides independent benchmark analysis of Meta's new proprietary Muse Spark model with detailed scores across multiple evaluations, highlighting its frontier-class performance and comparisons."
  },
  {
    "author": "Artificial Analysis",
    "username": "ArtificialAnlys",
    ...
    "relevance_note": "Announces a new AI agent benchmark leaderboard APEX-Agents-AA with detailed methodology and top model scores, advancing evaluation of AI in professional tasks."
  },
  {
    "author": "Artificial Analysis",
    "username": "ArtificialAnlys",
    ...
    "media_urls": [
      "https://pbs.twimg.com/media/HFW9QkBa8AEi0oh.jpg"
    ],
    "relevance_note": "Details the launch of Upstage's Solar Pro 3 AI model with comprehensive benchmark results, emphasizing strengths in agentic tasks and comparisons to other models."
  }
]

**說明**：搜尋僅找到 5 條高度相關推文（排除一條非嚴肅宣傳內容），原因是指定條件（min_faves:100+、特定關鍵字排除加密貨幣、最近 5 天內、Latest 模式）在該時間範圍內符合者有限，無更多官方公告或論文分享符合門檻。這些推文多來自知名 AI 分析帳號，提供數據佐證的新模型發布與基準測試。