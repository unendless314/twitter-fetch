...
executed_at: "2026-04-10T05:00:58.823944+08:00"
status: "success"
---
...
[
  {
    ...
    "relevance_note": "Reports on Alibaba's launch of a new AI video model topping benchmarks on Artificial Analysis, supported by screenshots. Meets criteria for AI release and benchmark achievement with high engagement."
  },
  {
    ...
    "relevance_note": "Detailed benchmark analysis of Meta's new Muse Spark model release by reputable AI analysis account, with comprehensive data and comparisons. High engagement and aligns with official announcements and benchmarks."
  },
  {
    "author": "Artificial Analysis",
    "username": "ArtificialAnlys",
    ...
    "relevance_note": "Announcement of new AI agent benchmark leaderboard with detailed results and methodology from a trusted AI evaluation source. Focuses on breakthroughs in agentic capabilities with data support."
  },
  {
    "author": "Artificial Analysis",
    "username": "ArtificialAnlys",
    ...
    "relevance_note": "Benchmark review of Upstage's newly launched Solar Pro 3 AI model, highlighting improvements and specs with data from Artificial Analysis. Prioritizes technical release with evidence."
  },
  {
    ...
    "media_urls": [
      "https://pbs.twimg.com/media/HFScS_QX0AEVQhE.jpg"
    ],
    "relevance_note": "Announces Harvard's launched free AI and data science courses, but focuses more on education than AI breakthroughs; included as it matches keywords but lower priority."
  }
]

**Note**: Only 5 tweets found matching the strict criteria (min_faves:100, language filter, time range since 2026-04-05, keyword exclusions). Likely due to the recent time frame and high engagement threshold limiting results in Latest mode. No additional tweets met min_faves:100.