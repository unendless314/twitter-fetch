# X Search 任務：macro_finance_keyword
...
### 優先收錄
央行政策聲明、總體經濟數據發布、利率決策分析、債券市場動態、匯率與大宗商品走勢、知名經濟學家觀點

### 排除內容
加密貨幣價格預測、個股推薦、純技術分析、無根據的市場謠言、投資廣告
