...
executed_at: "2026-04-11T05:01:19.321241+08:00"
status: "success"
---
...
[
  {
    ...
    "relevance_note": "Reports Alibaba's launch of new AI video model HappyHorse-1.0, achieving top benchmark rankings on Artificial Analysis with screenshots as evidence."
  },
  {
    ...
    "relevance_note": "Detailed independent benchmark of Meta's newly released Muse Spark model, ranking it in top 5 on Intelligence Index with comprehensive performance data and comparisons."
  },
  {
    "author": "Artificial Analysis",
    "username": "ArtificialAnlys",
    ...
    "relevance_note": "Announces new AI agent benchmark leaderboard APEX-Agents-AA with scores from top models like GPT-5.4 and Claude Opus 4.6 on professional tasks."
  },
  {
    "author": "Artificial Analysis",
    "username": "ArtificialAnlys",
    ...
    "relevance_note": "Details Upstage's launch of Solar Pro 3 AI model with benchmark scores on Intelligence Index and strengths in agentic tasks, including comparisons to other models."
  }
]

**Note:** Only 4 posts were found meeting the criteria (min_faves:100, language filter, exclusions, and content relevance) within the specified time range (since:2026-04-06). No additional qualifying posts were available in the latest 10 results from the search.